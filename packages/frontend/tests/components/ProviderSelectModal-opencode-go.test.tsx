...
describe('OpenCode Go subscription detail view', () => {
  ...
  it('shows the beta hint and never says Zen', () => {
    ...
    const hint = screen.getByText(/Sign in to OpenCode Go, copy your API key.*beta/i);
  ...
  it('saves a pasted token as a subscription connection', async () => {
    ...
    const input = screen.getByPlaceholderText('Paste your OpenCode API key') as HTMLInputElement;

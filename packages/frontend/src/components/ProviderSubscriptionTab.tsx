...
const ProviderSubscriptionTab: Component<Props> = (props) => {
  ...
  return (
    <>
      <div class="provider-modal__tab-hint">{t('provider.subscriptionHint')}</div>
      <div class="provider-modal__list">
          ...
          {(prov) => {
            ...
            return (
              ...
              >
                ...
                <div class="provider-toggle__actions">
                  <Show when={connected()}>
                    <button
                      class="provider-toggle__add-btn"
                      type="button"
                      aria-label={t('provider.addConnectionFor', { provider: prov.name })}
                      onClick={(e) => {
                        e.stopPropagation();
                        props.onAddKey(prov.id, 'subscription');
                      }}
                    >
                      <span class="provider-toggle__add-tooltip">
                        {t('provider.addConnection')}
                      </span>
                      <svg
        ...
        <div class="provider-modal__add-custom">
          ...
          >
            ...
            {t('provider.requestSubscriptionModel')}
          </a>
        </div>
      </div>
    </>

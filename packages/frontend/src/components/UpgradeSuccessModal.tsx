  ...
  return (
    <Show when={props.open}>
      <div class="modal-backdrop" onClick={() => props.onClose()}>
        <div class="modal upgrade-success-modal" onClick={(e) => e.stopPropagation()}>
          <div class="upgrade-success-modal__body">
            <div class="upgrade-success-modal__icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#2632EF" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <ul class="upgrade-success-modal__features">
              {features.map((f) => (
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#2632EF" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M9 15.59 4.71 11.3 3.3 12.71l5 5c.2.2.45.29.71.29s.51-.1.71-.29l11-11-1.41-1.41L9.02 15.59Z" />
                  </svg>
                  <span>{f}</span>
                </li>
            ...
            <button class="btn btn--primary upgrade-success-modal__done" onClick={() => props.onClose()}>
              Done
            </button>
          </div>
        </div>

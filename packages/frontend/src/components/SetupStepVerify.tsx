          ...
          <>
            ...
            <div class="modal-terminal">
              ...
              <div class="modal-terminal__body">
                ...
                <div class="modal-terminal__line modal-terminal__line--comment">
                  # Restart OpenClaw to activate the plugin
                </div>
                <div>
            ...
            <p style="margin: 16px 0 0; font-size: var(--font-size-sm); color: hsl(var(--muted-foreground)); line-height: 1.5;">
              Once restarted, send a message to your agent. Activity will appear on the dashboard a
              few seconds after the agent responds.
            </p>
          </>
        }
      >
        ...
        <p style="margin: 0; font-size: var(--font-size-sm); color: hsl(var(--muted-foreground)); line-height: 1.5;">
          Your agent is ready. Set <strong>manifest/auto</strong> as your model, send a message, and

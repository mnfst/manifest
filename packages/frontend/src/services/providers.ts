...
export const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    ...
    color: '#ff5f1f',
    initial: 'Ce',
    subtitle: 'Llama, Qwen, GPT-OSS and more',
    keyPrefix: '',
    minKeyLength: 20,
  ...
  },
  {
    ...
    color: '#f48120',
    initial: 'CF',
    subtitle: 'Account-scoped access to 40+ hosted models',
    keyPrefix: '',
    minKeyLength: 40,
  ...
  },
  {
    ...
    color: '#39594d',
    initial: 'Co',
    subtitle: 'Command, Aya, and Cohere-hosted chat models',
    keyPrefix: '',
    minKeyLength: 20,
    keyPlaceholder: 'API key',
    models: [],
  ...
  },
  {
    ...
    color: '#24292f',
    initial: 'GM',
    subtitle: 'GPT, Llama, DeepSeek, Mistral and more',
    keyPrefix: '',
    minKeyLength: 20,
  ...
  },
  {
    ...
    color: '#f55036',
    initial: 'Gr',
    subtitle: 'Ultra-fast Llama, Kimi, Qwen and more',
    keyPrefix: 'gsk_',
    minKeyLength: 20,
    keyPlaceholder: 'gsk_...',
    models: [],
  },
  {
    ...
    color: '#ffcc4d',
    initial: 'HF',
    subtitle: 'HF Inference Provider routing for open models',
    keyPrefix: 'hf_',
    minKeyLength: 20,
    keyPlaceholder: 'hf_...',
    models: [],
  },
  {
    ...
    color: '#0f766e',
    initial: 'L7',
    subtitle: 'Free-token gateway for many OpenAI-compatible models',
    keyPrefix: '',
    minKeyLength: 10,
  ...
  },
  {
    ...
    color: '#2563eb',
    initial: 'OC',
    subtitle: 'Hosted Ollama API for cloud models',
    keyPrefix: '',
    minKeyLength: 20,
    keyPlaceholder: 'API key',
    models: [],

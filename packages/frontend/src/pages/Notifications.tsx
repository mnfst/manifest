  ...
  return (
    <div class="container--sm">
      ...
      <div class="page-header">
        <div>
          <h1>Notifications</h1>
          <span class="breadcrumb">{agentName()} &rsaquo; Get notified when usage or costs exceed your limits</span>
        </div>
        ...
        <Show
          ...
          fallback={
            <div class="empty-state">
              <div class="empty-state__title">No alerts set up</div>
              <p>Create an alert to get notified when this agent uses more than a set amount of tokens or dollars.</p>
          ...
          <div class="settings-card">
            <table class="notif-table">
              ...
              <tbody>
                <For each={rules()}>
                  {(rule) => (
                    <tr class={rule.is_active ? "" : "notif-table__row--disabled"}>

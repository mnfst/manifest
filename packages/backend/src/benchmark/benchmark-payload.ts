import type { BenchmarkMessageDto, RunBenchmarkDto } from './dto/run-benchmark.dto';
 ...
 */
export function buildForwardBody(dto: RunBenchmarkDto): Record<string, unknown> {
 ...
 */
export function derivePromptForHistory(dto: RunBenchmarkDto): string {
...
function lastUserContent(messages: BenchmarkMessageDto[]): string {

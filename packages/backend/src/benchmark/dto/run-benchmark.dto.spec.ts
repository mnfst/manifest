...
import { BenchmarkPayloadShapeConstraint, RunBenchmarkDto } from './run-benchmark.dto';

function toDto(data: Record<string, unknown>): RunBenchmarkDto {
  return plainToInstance(RunBenchmarkDto, data);
}

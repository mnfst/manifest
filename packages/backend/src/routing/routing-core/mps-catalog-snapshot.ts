// Generated offline fallback: a point-in-time snapshot of the modelparams.dev
// MPS catalog. ProviderParamSpecService seeds its in-memory catalog from this
// when the remote is unreachable at boot, so the params UI is never empty
// offline. refreshCache() overwrites it on a successful fetch.
// Regenerate with: curl -s https://modelparams.dev/api/v1/models.json
export const MPS_CATALOG_SNAPSHOT: unknown = {
  $schema: 'https://modelparams.dev/api/v1/schema.json',
  generatedAt: '2026-05-21T12:05:08.567Z',
  count: 65,
  models: [
    {
      provider: 'anthropic',
      ...
      params: [
        ...
        },
        {
          ...
          description:
            'Controls randomness. Lower values make outputs more focused; higher values make them more varied.',
          group: 'sampling',
          applicability: { except: [{ 'thinking.type': ['enabled'] }, { top_p: { not: null } }] },
          type: 'number',
          default: 1,
          range: { min: 0, max: 1, step: 0.1 },
        },
        {
          ...
          group: 'sampling',
          applicability: {
            except: [{ 'thinking.type': ['enabled'] }, { temperature: { not: null } }],
          },
          type: 'number',
          default: 1,
          range: { min: 0, max: 1, step: 0.01 },
    ...
    },
    {
      ...
      params: [
        ...
        },
        {
          ...
          group: 'sampling',
          applicability: {
            except: [{ 'thinking.type': ['enabled', 'adaptive'] }, { top_p: { not: null } }],
          },
          type: 'number',
          default: 1,
          range: { min: 0, max: 1, step: 0.1 },
        },
        {
          ...
          group: 'sampling',
          applicability: {
            except: [{ 'thinking.type': ['enabled', 'adaptive'] }, { temperature: { not: null } }],
          },
          type: 'number',
          default: 1,
          range: { min: 0, max: 1, step: 0.01 },
        ...
        },
        {
          ...
          description: 'Controls whether Anthropic returns summarized or omitted thinking content.',
          group: 'reasoning',
          applicability: { only: { 'thinking.type': ['adaptive', 'enabled'] } },
          type: 'enum',
          default: 'summarized',
          values: ['summarized', 'omitted'],
        },

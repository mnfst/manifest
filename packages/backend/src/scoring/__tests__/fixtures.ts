...
export const FIXTURES: Fixture[] = [
  ...
  },
  {
    ...
    messages: [
      {
        role: 'user',
        content: 'Prove that there are infinitely many primes using proof by contradiction',
      },
    ],
    ...
    messages: [
      {
        role: 'user',
        content:
          'Write a short story about a detective who solves mysteries using only intuition and keen observation. Include dialogue and a plot twist.',
      },
    ],
    expectedTier: 'standard',
    keySignals: ['creative + moderate complexity'],
  },
  {
    ...
    messages: [
      {
        role: 'user',
        content: 'Forward to the team: meeting at 3pm today and summarize the agenda',
      },
    ],
    expectedTier: 'standard',
  ...
  },
  {
    ...
    messages: [
      {
        role: 'user',
        content: 'Create an issue for the API bug we discussed and assign it to the backend team',
      },
    ],
    expectedTier: 'standard',
  ...
  },
  {
    ...
    expectedTier: 'reasoning',
    keySignals: ['single formal logic keyword triggers override (threshold >= 1)'],
  },
  {

import { AddAgentApiKeyPrefixActiveIndex1787000000000 } from './1787000000000-AddAgentApiKeyPrefixActiveIndex';

describe('AddAgentApiKeyPrefixActiveIndex1787000000000', () => {
  let migration: AddAgentApiKeyPrefixActiveIndex1787000000000;
  let queryRunner: { query: jest.Mock };

  beforeEach(() => {
    migration = new AddAgentApiKeyPrefixActiveIndex1787000000000();

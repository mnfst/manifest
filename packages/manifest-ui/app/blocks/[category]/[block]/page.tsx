...
/>`
  ...
  data={{
    post: {
      ...
      author: { name: "Alex Rivera", avatar: "/demo/avatars/alex-150.jpg" },
...
/>`
  ...
  data={{
    post: {
      ...
      author: { name: "Jordan Kim", avatar: "/demo/avatars/jordan-150.jpg" },
...
/>`
  ...
  data={{
    post: {
      ...
      coverImage: "/demo/images/tech-ecommerce.jpg",
      author: { name: "Morgan Lee", avatar: "/demo/avatars/morgan-150.jpg" },
...
/>`
  ...
  data={{
    post: {
      ...
      coverImage: "/demo/images/tech-ai.jpg",
      author: { name: "Taylor Swift", avatar: "/demo/avatars/taylor-150.jpg" },
  ...
  data={{
    posts: [
      ...
      },
      {
        ...
        title: "Designing for Conversational Interfaces",
        excerpt: "Best practices for creating intuitive UI components that work within chat environments.",
        coverImage: "/demo/images/tech-ux.jpg",
        author: { name: "Alex Rivera", avatar: "/demo/avatars/alex-150.jpg" },
        publishedAt: "2024-01-12",
        readTime: "8 min read",
        tags: ["Design", "UX"],
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-cloud.jpg",
        author: { name: "Jordan Kim", avatar: "/demo/avatars/jordan-150.jpg" },
        publishedAt: "2024-01-10",
        readTime: "12 min read",
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-team.jpg",
        author: { name: "Casey Taylor", avatar: "/demo/avatars/casey-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-women.jpg",
        author: { name: "Jamie Park", avatar: "/demo/avatars/jamie-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-dashboard.jpg",
        author: { name: "Drew Martinez", avatar: "/demo/avatars/drew-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-remote.jpg",
        author: { name: "Riley Johnson", avatar: "/demo/avatars/riley-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-code.jpg",
        author: { name: "Avery Williams", avatar: "/demo/avatars/avery-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-seo.jpg",
        author: { name: "Quinn Anderson", avatar: "/demo/avatars/quinn-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-debug.jpg",
        author: { name: "Sage Thompson", avatar: "/demo/avatars/sage-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-marketing.jpg",
        author: { name: "Blake Garcia", avatar: "/demo/avatars/blake-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-mobile.jpg",
        author: { name: "Charlie Brown", avatar: "/demo/avatars/charlie-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-dashboard.jpg",
        author: { name: "Sydney Chen", avatar: "/demo/avatars/sydney-150.jpg" },
      ...
      },
      {
        ...
        coverImage: "/demo/images/tech-design.jpg",
        author: { name: "Taylor Swift", avatar: "/demo/avatars/taylor-150.jpg" },
...
/>`
  ...
  data={{
    event: {
      ...
      priceRange: "$45 - $150",
      image: "/demo/images/event-music.jpg",
...
/>`
  ...
  data={{
    event: {
      ...
      images: [
        "/demo/images/event-music.jpg",
        "/demo/images/event-edm.jpg"
      ],
      description: "Experience the raw energy of underground techno.",
      attendeesCount: 537,
      friendsGoing: [
        { name: "Alex", avatar: "/demo/avatars/alex-40.jpg" },
        { name: "Sam", avatar: "/demo/avatars/sam-40.jpg" }
      ],
      organizer: {
        id: "1",
        name: "Midnight Lovers",
        image: "/demo/avatars/midnight-80.jpg",
        rating: 4.6,
        reviewCount: 1876,
        verified: true,
        followers: 1200,
        ...
        variants: [
          {
            id: 'default',
            name: 'Default',
            component: <TicketTierSelect data={{ event: { title: "Player Play Date", date: "Fri, Feb 06 · 2:00 pm", image: "/demo/images/event-conference.jpg", currency: "USD" } }} />,
            usageCode: `<TicketTierSelect
  data={{
    event: {
      title: "Player Play Date",
      date: "Fri, Feb 06 · 2:00 pm",
      image: "/demo/images/event-conference.jpg",
      currency: "USD"
    },
    tiers: [
      {
        ...
        variants: [
          {
            id: 'default',
            name: 'Default',
            component: <EventCheckout data={{ event: { title: "Player Play Date", date: "Fri, Feb 06 · 2:00 pm", image: "/demo/images/event-conference.jpg", price: "$25.05", currency: "USD" } }} actions={{ onBack: () => {}, onPlaceOrder: () => {} }} />,
...
/>`
  ...
  data={{
    ...
    organizer: {
      name: "CavityFree SF",
      image: "/demo/avatars/cavityfree-80.jpg"
    }
  }}
  actions={{
              ...
              <div className="space-y-3">
                <MessageBubble
                  data={{
                    ...
                    avatarUrl: '/demo/avatars/sarah-150.jpg',
                    avatarFallback: 'S',
                    time: 'Dec 8, 10:30 AM'
                  }}
                />
            ...
            component: (
              <div className="space-y-3">
                <ImageMessageBubble
                  data={{
                    image:
                      '/demo/images/thumbnail-2.jpg',
                    content: 'Check out this view!',
                    avatarUrl: '/demo/avatars/alex-150.jpg',
                    avatarFallback: 'A',
                    time: 'Dec 8, 2:45 PM'
                  }}
                />
...
/>`
  ...
  data={{
    content: "We just hit 10,000 users!",
    avatarUrl: "/demo/avatars/team-150.jpg",
    avatarFallback: "T",
    author: "Team",
    time: "4:20 PM",
    reactions: [
...
/>`
            ...
            component: (
              <div className="space-y-3">
                <VoiceMessageBubble
                  data={{
                    duration: '0:42',
                    avatarUrl: '/demo/avatars/mickael-150.jpg',
                    avatarFallback: 'M',
                    time: 'Dec 8, 3:15 PM'
                  }}
                />
  ...
  data={{
    duration: "0:42",
    avatarUrl: "/demo/avatars/mike-150.jpg",
    avatarFallback: "M",
    author: "Mike",
    time: "3:15 PM",
  ...
  data={{
    messages: [
      ...
      },
      {
        ...
        image: "/demo/images/thumbnail-3.jpg",
        author: "Sarah",
        avatarUrl: "/demo/avatars/sarah-150.jpg",
        avatarFallback: "S",
        time: "10:32 AM",

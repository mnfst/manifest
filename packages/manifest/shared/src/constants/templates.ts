import type { LayoutTemplate } from '../types/app.js';
import type { TemplateDefinition } from '../types/templates.js';

const STAT_CARD_SAMPLE_DATA = {
  stats: [
    {
      label: 'Total Revenue',
      value: '$45,231.89',
...
const STAT_CARD_DEFAULT_CODE = `import { TrendingUp, TrendingDown, Minus } from 'lucide-react'
...
const POST_LIST_SAMPLE_DATA_NEW = {
  posts: [
    {
      id: '1',
...
const POST_LIST_DEFAULT_CODE_NEW = `// Customize this component to change how your posts are displayed
...
const BLANK_COMPONENT_SAMPLE_DATA = {
 ...
 */
const TEMPLATE_DEFINITIONS: Record<LayoutTemplate, TemplateDefinition> = {
  'stat-card': {

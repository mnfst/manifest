...
## Recent Changes
- 002-mcp-server-flow: Added TypeScript 5.7.2, Node.js >=18.0.0 + NestJS 10.4.15, React 18.3.1, Vite 6.0.5, TypeORM 0.3.20, LangChain 0.3.26

- 001-chatgpt-app-builder: Added TypeScript 5.x (all packages)
